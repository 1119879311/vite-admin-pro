...
const App = ()=>{
    ...
    return <div className="test2-warp">
        ...
        <VirtualList ref={listRef} data={data} rowKey="key" itemSize={150} renderItem={(itemProps)=>RenderItme({...itemProps,ativeIndex:index,onSelect:onSelect}) } layout={"horizontal"} totals={data.length}/>
    </div>
}
